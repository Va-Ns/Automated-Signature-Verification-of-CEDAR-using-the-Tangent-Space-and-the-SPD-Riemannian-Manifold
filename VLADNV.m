function VLAD_Encoding = VLADNV(Codebooks,Data,Options)

arguments

    Codebooks             {mustBeUnderlyingType(Codebooks,"struct")}
    Data                  {mustBeUnderlyingType(Data,"struct")}
    Options.numNeighbors  {mustBeInteger,mustBeNonempty,mustBeNonmissing}
    ...
    %% For the Learning Set
        ...
        for Curr_data = 1:numTrainingSamples
            [~, G_Train_index{Curr_data}] = pdist2(Codebooks.G_Train_Codebook, ...
                                      Data.G_Training_set(Curr_data,:), "euclidean", "Smallest", ...
                                                                              Options.numNeighbors);
            G_Train_Residual{Curr_data} = abs(Data.G_Training_set(Curr_data,:) - ...
        ...
        for Curr_data = 1:numTrainingSamples
            ...
            [~, F_Train_index{Curr_data}] = pdist2(Codebooks.F_Train_Codebook, ...
                                      Data.F_Training_set(Curr_data,:), "euclidean", "Smallest", ...
                                                                              Options.numNeighbors);
            F_Train_Residual{Curr_data} = abs(Data.F_Training_set(Curr_data,:) - ...
    ...
    %% For the Validation Set
        ...
        for Curr_data = 1:numValidationSamples
            ...
            [~, G_Val_index{Curr_data}] = pdist2(Codebooks.G_Val_Codebook, ...
                                      Data.G_Val_set(Curr_data,:), "euclidean", "Smallest", ...
                                                                              Options.numNeighbors);
            G_Val_Residual{Curr_data} = abs(Data.G_Val_set(Curr_data,:) - ...
        ...
        for Curr_data = 1:numValidationSamples
            ...
            [~, F_Val_index{Curr_data}] = pdist2(Codebooks.F_Val_Codebook, ...
                                      Data.F_Val_set(Curr_data,:), "euclidean", "Smallest", ...
                                                                              Options.numNeighbors);
            F_Val_Residual{Curr_data} = abs(Data.F_Val_set(Curr_data,:) - ...
